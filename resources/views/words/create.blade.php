                                ...
                                <div class="flex flex-wrap -m-2">
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="text" id="word_en" name="word_en" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            @error('word_en')
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="text" id="word_ja" name="word_ja" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            @error('word_ja')
                                            <p class="text-rose-700">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="p-2 w-full md:w-1/2">
                                        <div class="relative">
                                            ...
                                            <select name="memory" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                <option value="">選択してください</option>
                                                <option value="1">覚えた</option>
                                                <option value="2">たまに忘れる</option>
                                                <option value="3">よく忘れる</option>
                                            </select>
                                            @error('memory')
                                            <p class="text-rose-700">{{ $message }}</p>
                                            @enderror
